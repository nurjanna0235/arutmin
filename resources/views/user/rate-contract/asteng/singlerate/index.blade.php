...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <nav>
            ...
            <div class="mb-4">
            <form method="GET" action="{{ url('/user/rate-contract/asteng/single-rate') }}" class="d-flex align-items-center gap-3">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex gap-2 justify-content-center">
                                    <!-- Tombol Detail -->
                                    <a href="{{ url('/user/rate-contract/asteng/single-rate/detail/' . $item->id) }}" >
