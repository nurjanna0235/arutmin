...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <div class="mb-4">
            <form method="GET" action="{{ url('/user/rate-contract/astim/top-soil-lcm') }}"
                ...
                <tbody>
                    ...
                    @foreach($dokumentop_soil_lcm as $item)
                        <tr>
                            ...
                            <td>
                                <!-- Basic Modal -->
                                <a href="{{ url('user/rate-contract/astim/top-soil-lcm/view/' . $item->id) }}" type="button" class="btn"
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a
                                        href="{{ url('user/rate-contract/astim/top-soil-lcm/detail/' . $item->id) }}">
