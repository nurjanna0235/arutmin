    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <!-- Vertical Form -->
                    <form action="/user/rate-contract/astim/fuel-lcm/simpan" method="POST" class="row g-3"
                        ...
                        <div class="col-12 mt-3">
                            <div class="d-flex justify-content-start">
                                ...
                                <a href="/user/rate-contract/astim/fuel-lcm" class="btn btn-secondary">Kembali</a>
                            </div>
                        </div>
                    </form><!-- Vertical Form -->
                </div>
