...
@section('conten')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <div class="mb-4">
                <form method="GET" action="{{ url('/user/rate-contract/astim/fuel-lcm') }}"
                    ...
                    <tbody>
                        ...
                        @foreach ($dokument as $key => $item)
                            <tr>
                                <td>{{ $No++ }}</td>
                                <td>
                                <a class="btn" href="{{ url('user/rate-contract/astim/fuel-lcm/view/' . $item->id_contract) }}"> {{ $item->created_at }}</a>
                                </td>
                                <td>
