...
<div class="pagetitle">
        ...
        <div class="mb-4">
            <form method="GET" action="{{ url('/user/rate-contract/asbar/haul-road-maintenance-pltu') }}" class="d-flex align-items-center gap-3">
                ...
                @foreach($dokumenhaulroadmaintenancepltu as $item)
                        ...
                        <tr>
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                    <!-- Tombol Detail -->
                                    <a href="{{ url('user/rate-contract/asbar/haul-road-maintenance-pltu/detail/' . $item->id) }}" >
