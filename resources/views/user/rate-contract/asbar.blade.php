                                ...
                                <div class="col">
                                    <div class="card-body">
                                        ...
                                        <div class="container text-center">
                                            <!-- Default List group -->
                                            <ul class="list-group">
                                                <a href="/user/rate-contract/asbar/coal-hauling">
                                                    <li class="list-group-item active">Coal Hauling to PLTU</li>
                                                </a>
                                                <a href="/user/rate-contract/asbar/haul-road-maintenance-pltu">
                                                <li class="list-group-item ">Haul Road Maintenance PLTU</li>
                                            </a>
                                            <a href="/user/rate-contract/asbar/daywork-asbar">
                                                <li class="list-group-item active">Daywork</li>
                                            </a>
                                                <a href="/user/rate-contract/asbar/fuel-asbar">
