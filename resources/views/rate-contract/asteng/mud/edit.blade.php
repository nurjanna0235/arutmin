                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                                ...
                                <input  value="{{ $dokumenmud->mud_removal_load_and_haul }}" name= "mud_removal_load_and_haul" type="text" class="form-control" id="mud_removal_load_and_haul">
                            </div>

                            <div class="col-12">
                                <label for="currency_adjustment" class="form-label">Currency Adjustment</label>
                                <input  value="{{ $dokumenmud->currency_adjustment }}" name= "currency_adjustment" type="text" class="form-control" id="currency_adjustment">
                            </div>

                            <div class="col-12">
                                <label for="premium_rate" class="form-label">Premium Rate</label>
                                <div class="input-group mb-3">
                                 <input  value="{{ $dokumenmud->premium_rate }}" type="text" class="form-control" name="premium_rate">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                <input  value="{{ $dokumenmud->general_escalation }}" type="text" class="form-control" name="general_escalation">
                                <span class="input-group-text" id="basic-addon2">%</span>
                            </div>

                           {{-- <div class="col-12">
                                <label for="rate_actual" class="form-label">Rate Actual (Rp/Ha)</label>
                                <input  value="{{ $dokumenmud->rate_actual }}" name= "rate_actual" type="text" class="form-control" id="rate_actual">
                            </div> --}}
