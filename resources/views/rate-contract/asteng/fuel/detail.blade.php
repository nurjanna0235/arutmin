                        ...
                        <div class="row">
                            ...
                            <form action="/rate-contract/asteng/fuel/simpan" method="POST" class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input readonly value="{{ $dokumenfuel->activity }}" name="activity" type="text"
                                        class="form-control" id="activity">
                                </div>
                                <div class="col-12">
                                    <label for="item" class="form-label">Item</label>
                                    <input readonly value="{{ $dokumenfuel->item }}" name="item" type="text"
                                        class="form-control" id="item">
                                </div>
                                <div class="col-12">
                                    <label for="fuel_index" class="form-label">Fuel Index</label>
                                    <input readonly value="{{ $dokumenfuel->fuel_index }}" name="fuel_index"
                                        type="text" class="form-control" id="fuel_index">
                                </div>
                                <div class="col-12">
