...
<main id="main" class="main">
    ...
    <div class="mb-4">
        <form method="GET" action="{{ url('/rate-contract/asteng/fuel') }}" class="d-flex align-items-center gap-3">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                <!-- Tombol Detail -->
                                <a href="{{ url('rate-contract/asteng/fuel/detail/' . $item->id) }}">
                                    <i class="ri-information-line text-primary" title="Detail"></i>
                                </a>

                                <!-- Tombol Edit -->
                                <a href="{{ url('rate-contract/asteng/fuel/edit/' . $item->id) }}">
                                    <i class="ri-edit-2-line text-warning" title="Edit"></i>
                                </a>

                                <!-- Tombol Hapus -->
                                <form action="{{ url('/rate-contract/asteng/fuel/delete/' . $item->id) }}" method="POST" 
