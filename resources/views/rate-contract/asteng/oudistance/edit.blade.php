            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        @if($dokumen_oudistance->contract_reference)
                            <div class="mb-2">
                                <a href="{{ asset('storage/' . $dokumen_oudistance->contract_reference) }}" target="_blank">
                                    <img src="{{ asset('storage/' . $dokumen_oudistance->contract_reference) }}" alt="Image" style="max-width: 200px;">
                                </a>
                            </div>
