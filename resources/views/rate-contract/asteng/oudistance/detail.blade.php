    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <form action="/rate-contract/asteng/oudistance/simpan" method="POST" class="row g-3">
                ...
                <div class="col-12">
                    <a href="{{ asset('storage/' . $dokumenoudistance->contract_reference) }}" target="_blank">
                        <img src="{{ asset('storage/' . $dokumenoudistance->contract_reference) }}" alt="Image" style="max-width: 200px;">
                    </a>
                </div>
