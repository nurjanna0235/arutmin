...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <div class="mb-4">
            <form method="GET" action="{{ url('/rate-contract/asteng/other') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex gap-2 justify-content-center">
                                    <!-- Tombol Detail -->
                                    <a
                                        href="{{ url('rate-contract/asteng/other/detail/' . $item->id) }}">
                                        <i class="ri-information-line" title="Detail"></i>
                                    </a>

                                    <!-- Tombol Edit -->
                                    <a
                                        href="{{ url('rate-contract/asteng/other/edit/' . $item->id) }}">
                                        <i class="ri-edit-2-line text-warning" title="Edit"></i>
                                    </a>

                                    <!-- Tombol Hapus -->
                                    <form
                                        action="{{ url('/rate-contract/asteng/other/delete/' . $item->id) }}"
                                        method="POST"
