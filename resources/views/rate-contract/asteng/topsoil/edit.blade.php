                    ...
                    <div class="row">
                        ...
                        <form action="/rate-contract/asteng/top-soil/update/{{ $dokumentop_soil->id }}" method="POST"
                            ...
                            <div class="col-12">
                                ...
                                <input value="{{ $dokumentop_soil->base_rate }}"
                                name="base_rate" type="text" class="form-control" id="base_rate">
                            </div>

                            <div class="col-12">
                                <label for="currency_adjustment" class="form-label">Currency Adjustment</label>
                                <input value="{{ $dokumentop_soil->currency_adjustment }}"
                            ...
                            <div class="col-12">
                                ...
                                <input value="{{ $dokumentop_soil->premium_rate }}" name="premium_rate" type="text" class="form-control" id="premium_rate">
                            </div>

                            <div class="col-12">
                                <label for="general_escalation" class="form-label">General Escalation</label>
                                <input value="{{ $dokumentop_soil->general_escalation }}" name="general_escalation" type="text" class="form-control" id="general_escalation">
                            </div>

                            <div class="col-12">
                                <label for="rate_actual" class="form-label">Rate Actual</label>
                                <input value="{{ $dokumentop_soil->rate_actual }}" 
