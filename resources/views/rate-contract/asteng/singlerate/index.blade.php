                            ...
                            <div class="icon">
                                <div class="icon">
                                    <a href="{{ url('rate-contract/asteng/single-rate/detail/' . $item->id) }}"
                                        type="button" class="btn btn-primary"><i></i>Detail</a>
                                    <a href="{{ url('rate-contract/asteng/single-rate/edit/' . $item->id) }}"
                                        type="button" class="btn btn-warning" style="color: white"><i></i>Edit</a>
                                    <form
                                        action="{{ url('/rate-contract/asteng/single-rate/delete/' . $item->id) }}" method="POST"
