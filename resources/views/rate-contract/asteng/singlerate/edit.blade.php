                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-12">
                                ...
                                <input  value="{{ $dokumensingle_rate->total_base_rate_ob }}"  name= "total_base_rate_ob" type="text" class="form-control" id="total_base_rate_ob">
                            </div>

                            <div class="col-12">
                                <label for="total_base_rate_coal" class="form-label">Total Base Rate Coal (Rp/ton)</label>
                                <input  value="{{ $dokumensingle_rate->total_base_rate_coal }}"  name= "total_base_rate_coal" type="text" class="form-control" id="total_base_rate_coal">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <input  value="{{ $dokumensingle_rate->currency_adjustment }}"  name= "currency_adjustment" type="text" class="form-control" id="currency_adjustment">
                            </div>

                            <div class="col-12">
                                <label for="premium_rate" class="form-label">Premium Rate</label>
                                <div class="input-group mb-3">
                                 <input  value="{{ $dokumensingle_rate->premium_rate }}"  type="text" class="form-control" name="premium_rate">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                <input  value="{{ $dokumensingle_rate->general_escalation }}"  type="text" class="form-control" name="general_escalation">
                                <span class="input-group-text" id="basic-addon2">%</span>
                            </div>

                           {{-- <div class="col-12">
                                <label for="total_single_rate_actual" class="form-label">Total Single Rate Actual (Rp/ton)</label>
                                <input  value="{{ $dokumensingle_rate->total_single_rate_actual }}"  name= "total_single_rate_actual" type="text" class="form-control" id="total_single_rate_actual">
                            </div> --}}
