            ...
            <section class="section dashboard">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <!-- Vertical Form -->
                            <form action="/rate-contract/asteng/single-rate/simpan" method="POST" class="row g-3">
                                @csrf
                                <div class="col-12">
                                    ...
                                    <input readonly value="{{ $dokumensingle_rate->total_base_rate_ob }}"
                                        name="total_base_rate_ob" type="text" class="form-control" id="total_base_rate_ob">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input readonly value="{{ $dokumensingle_rate->total_base_rate_coal }}"
                                        name="total_base_rate_coal" type="text" class="form-control"id="total_base_rate_coal">
                                </div>

                                <div class="col-12">
                                    <label for="sr" class="form-label">SR</label>
                                    <input readonly value="{{ $dokumensingle_rate->sr }}" 
                                        name="sr" type="text" class="form-control" id="sr">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input readonly value="{{ $dokumensingle_rate->total_single_rate_actual }}"
                                        name="total_single_rate_actual" type="text" class="form-control" id="total_single_rate_actual">
                                </div>
