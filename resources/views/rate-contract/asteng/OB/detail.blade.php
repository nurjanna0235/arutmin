                        ...
                        <div class="row">
                            ...
                            <form action="/rate-contract/asteng/ob/simpan" method="POST" class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input readonly value="{{ $dokumenob->load_and_haul }}" name="load_and_haul" type="text" class="form-control" id="load_and_haul">
                                </div>

                                <div class="col-12">
                                    <label for="drill_and_blast" class="form-label">Drill and Blast (if required) (Rp/BCM)</label>
                                    <input readonly value="{{ $dokumenob->drill_and_blast }}" name="drill_and_blast" type="text" class="form-control" id="drill_and_blast">
                                </div>

                                <div class="col-12">
                                    <label for="pit_support" class="form-label">Pit Support (Rp/BCM)</label>
                                    <input readonly value="{{ $dokumenob->pit_support }}" name="pit_support" type="text" class="form-control" id="pit_support">
                                </div>

                                <div class="col-12">
                                    <label for="pit_lighting" class="form-label">Pit Lighting (Rp/BCM)</label>
                                    <input readonly value="{{ $dokumenob->pit_lighting }}" name="pit_lighting"  type="text" class="form-control" id="pit_lighting">
                                </div>

                                <div class="col-12">
                                    <label for="hrm" class="form-label">HRM</label>
                                    <input readonly value="{{ $dokumenob->hrm }}" name="hrm" type="text" class="form-control" id="hrm">
                                </div>

                                <div class="col-12">
                                    <label for="dump_maintenance" class="form-label">Dump Maintenance (Rp/BCM)</label>
                                    <input readonly value="{{ $dokumenob->dump_maintenance }}" name="dump_maintenance" type="text" class="form-control" id="dump_maintenance">
                                </div>

                                <div class="col-12">
                                    <label for="dewatering_sediment" class="form-label">Dewatering/Sediment(Rp/BCM)</label>
                                    <input readonly value="{{ $dokumenob->dewatering_sediment }}" name="dewatering_sediment" type="text" class="form-control" id="dewatering_sediment">
                                </div>

                                <div class="col-12">
                                    <label for="sr" class="form-label">Sub Total Base Rate OB (Rp/BCM)</label>
                                    <input readonly value="{{ $dokumenob->sub_total_base_rate_ob }}" name="sub_total_base_rate_ob" type="text" class="form-control" id="sub_total_base_rate_ob">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input readonly value="{{ $dokumenob->premium_rate }}" name="premium_rate" type="text" class="form-control" id="premium_rate">
                                </div>

                                <div class="col-12">
                                    <label for="general_escalation" class="form-label">General Escalation</label>
                                    <input readonly value="{{ $dokumenob->general_escalation }}" name="general_escalation" type="text" class="form-control" id="general_escalation">
                                </div>

                                <div class="col-12">
                                    <label for="total_rate_ob_actual" class="form-label">Total Rate OB Actual (Rp/BCM)</label>
                                    <input readonly value="{{ $dokumenob->total_rate_ob_actual }}" name="total_rate_ob_actual" type="text" class="form-control" id="total_rate_ob_actual">
                                </div>
                                ...
                                <div class="col-12">
                                    <a href="{{ asset('storage/' . $dokumenob->contract_reference) }}" target="_blank">
                                        <img src="{{ asset('storage/' . $dokumenob->contract_reference) }}" alt="Image" style="max-width: 200px;">
                                    </a>
                                </div>
