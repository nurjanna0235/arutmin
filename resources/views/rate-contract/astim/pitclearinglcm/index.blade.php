...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <div class="icon mb-3">
            <a href="/rate-contract/astim/pit-clearing/tambah" type="button" class="btn btn-success"><i></i>Tambah</a>
        </div>

        <!-- Form untuk pencarian -->
        <div class="mb-4">
            <form method="GET" action="{{ url('/rate-contract/astim/pit-clearing') }}" class="d-flex align-items-center gap-3">
