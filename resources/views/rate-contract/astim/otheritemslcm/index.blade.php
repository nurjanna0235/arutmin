...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <div class="icon mb-3">
            <a href="/rate-contract/astim/other-items-lcm/tambah" type="button"
                class="btn btn-success"><i></i>Tambah</a>
        </div>

        <!-- Form untuk pencarian -->
        <div class="mb-4">
            <form method="GET" action="{{ url('/rate-contract/astim/other-items-lcm') }}"
                ...
                <tbody>
                    ...
                    @foreach($dokumenother_items_lcm as $item)
                        <tr>
                            ...
                            <td>
                                <!-- Basic Modal -->
                                <a type="button" class="btn" href="{{ url('rate-contract/astim/other-items-lcm/view/' . $item->id) }}" >
                                    {{ $item->bulan_tahun }}
                                </a>
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    <a
                                        href="{{ url('rate-contract/astim/other-items-lcm/detail/' . $item->id) }}">
                                        <i class="ri-information-line" title="Detail"></i>
                                    </a>
                                    <a
                                        href="{{ url('rate-contract/astim/other-items-lcm/edit/' . $item->id) }}">
                                        <i class="ri-edit-2-line text-warning" title="Edit"></i>
                                    </a>
                                    <form
                                        action="{{ url('/rate-contract/astim/other-items-lcm/delete/' . $item->id) }}"
                                        method="POST"
