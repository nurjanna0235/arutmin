    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <!-- Vertical Form -->
                    <form action="/rate-contract/astim/coal-lcm/simpan" method="POST" class="row g-3"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-12">
                                            <input name="coal_hauling_lebih_dari" type="text" class="form-control" >
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-12">
                                            <input name="coal_hauling_kurang_dari" type="text" class="form-control">
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="col-12 mt-3">
                            <div class="d-flex justify-content-start">
                                ...
                                <a href="/rate-contract/astim/coal-lcm" class="btn btn-secondary">Batal</a>
                            </div>
                        </div>
                    </form><!-- Vertical Form -->
                </div>
