...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        ...
        <div class="icon mb-3">
            <a href="/rate-contract/astim/mud-lcm/tambah" type="button"
                class="btn btn-success"><i></i>Tambah</a>
        </div>

        <!-- Form untuk pencarian -->
        <div class="mb-4">
            <form method="GET" action="{{ url('/rate-contract/astim/mud-lcm') }}"
                ...
                <tbody>
                    ...
                    @foreach($dokumenmud_lcm as $item)
                        <tr>
                            ...
                            <td>
                                <!-- Basic Modal -->
                                <a type="button" class="btn" href="{{ url('rate-contract/astim/mud-lcm/view/' . $item->id) }}" >
                                    {{ $item->bulan_tahun }}
                                </a>
