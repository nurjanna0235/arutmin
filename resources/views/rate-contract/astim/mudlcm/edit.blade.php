    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <!-- Vertical Form -->
                    <form action="/rate-contract/astim/mud-lcm/update/{{ $dokumenmud_lcm->id }}" method="POST"
                                    ...
                                    <td>
                                        <div class="col-12">
                                            <input name="mud_removal_lebih_dari" type="number" class="form-control" 
                                                   value="{{ old('mud_removal_lebih_dari', $dokumenmud_lcm->mud_removal_lebih_dari) }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="col-12">
                                            <input name="mud_removal_kurang_dari" type="number" class="form-control" 
                                                   value="{{ old('mud_removal_kurang_dari', $dokumenmud_lcm->mud_removal_kurang_dari) }}">
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="col-12">
                            ...
                            <input value="{{ $dokumenmud_lcm->name_contract }}" name="name_contract" type="text"
                                class="form-control" id="name_contract">
                        </div>
                        <div class="col-12">
                            <label for="contract_reference" class="form-label">Contract Reference</label>
                            @if($dokumenmud_lcm->contract_reference)
                            <div class="mb-2">
                                <a href="{{ asset('storage/' . $dokumenmud_lcm->contract_reference) }}"
                                    target="_blank">
                                    <img src="{{ asset('storage/' . $dokumenmud_lcm->contract_reference) }}"
