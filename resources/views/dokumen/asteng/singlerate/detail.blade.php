                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <form action="/dokumen/asteng/single-rate/simpan" method="POST" class="row g-3">
                                @csrf
                                <div class="col-12">
                                    <label for="total_base_rate_ob" class="form-label">Total Base Rate OB
                                        (Rp/BCM)</label>
                                    <input readonly value="{{ $dokumensingle_rate->total_base_rate_ob }}"
                                        name="total_base_rate_ob" type="text" class="form-control"
                                        id="total_base_rate_ob">
                                </div>
                                <div class="col-12">
                                    <label for="total_base_rate_coal" class="form-label">Total Base Rate Coal
                                        (Rp/ton)</label>
                                    <input readonly value="{{ $dokumensingle_rate->total_base_rate_coal }}"
                                        name="total_base_rate_coal" type="text" class="form-control"
                                        id="total_base_rate_coal">
                                </div>
                                <div class="col-12">
                                    <label for="sr" class="form-label">SR</label>
                                    <input readonly value="{{ $dokumensingle_rate->sr }}" name="sr" type="text"
                                        class="form-control" id="sr">
                                </div>
                                <div class="col-12">
                                    <label for="currency_adjustment" class="form-label">Currency Adjustment</label>
                                    <input readonly value="{{ $dokumensingle_rate->currency_adjustment }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <input readonly value="{{ $dokumensingle_rate->premium_rate }}"
                                        name="premium_rate" type="text" class="form-control" id="premium_rate">
                                </div>
                                <div class="col-12">
                                    <label for="general_escalation" class="form-label">General Escalation</label>
                                    <input readonly value="{{ $dokumensingle_rate->general_escalation }}"
                                        name="general_escalation" type="text" class="form-control"
                                        id="general_escalation">
                                </div>
                                <div class="col-12">
                                    <label for="total_single_rate_actual" class="form-label">Total Single Rate Actual
                                        (Rp/ton)</label>
                                    <input readonly value="{{ $dokumensingle_rate->total_single_rate_actual }}"
                                        name="total_single_rate_actual" type="text" class="form-control"
                                        id="total_single_rate_actual">
                                </div>
                                <div class="col-12">
                                    <label for="contract_reference" class="form-label">Contract Reference</label>
                                    <input readonly value="{{ $dokumensingle_rate->contract_reference }}"
