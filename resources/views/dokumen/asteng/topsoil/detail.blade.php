            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Rp {{$dokumentop_soil->base_rate}} / Ha</td>
                    ...
                    <tr>
                        ...
                        <td>{{$dokumentop_soil->currency_adjustment}}</td>
                    </tr>
                    <tr>
                        <th scope="row">3</th>
                        <td>Premium Rate</td>
                        <td>{{$dokumentop_soil->premium_rate}}</td>
                    </tr>
                    <tr>
                        <th scope="row">4</th>
                        <td>General Escalation</td>
                        <td>{{$dokumentop_soil->general_escalation}}</td>
                    </tr>
                    <tr>
                        <th scope="row">5</th>
                        <td>Rate Actual (Rp/Ha)</td>
                        <td>Rp{{$dokumentop_soil->rate_actual}} /Ha</td>
                    </tr>
                    <tr>
                        <th scope="row">6</th>
                        <td>Contract Reference</td>
                        <td>{{$dokumentop_soil->contract_reference}}</td>
                    </tr>
