                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input  readonly value="{{ $dokumentop_soil->currency_adjustment }}"name= "currency_adjustment" type="text" class="form-control" id="currency_adjustment">
                            </div>
                            <div class="col-12">
                                <label for="premium_rate" class="form-label">Premium Rate</label>
                                <input  readonly value="{{ $dokumentop_soil->premium_rate }}" name= "premium_rate" type="text" class="form-control" id="premium_rate">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input  readonly value="{{ $dokumentop_soil->contract_reference }}" name= "contract_reference" type="text" class="form-control" id="contract_reference">
                            </div>
                                </select>
