            ...
            <table class="table datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <a href="{{url('dokumen/asteng/other/detail/'.$item->id)}} " type="button" class="btn btn-primary">Detail</a>
            ...
            <table class="table datatable">
                ...
                <tbody>
                    <?php
                        $No = 1;
                    ?>
                    @foreach($dokumensinglerate as $item)
                    <tr>

                        <td>{{$No++}}</td>
                        <td>{{$item->created_at}}</td>
                        <td> <a href="{{url('dokumen/asteng/single-rate/detail/'.$item->id)}} " type="button" class="btn btn-primary">Detail</a>
                            <button type="button" class="btn btn-danger">Hapus</button>
