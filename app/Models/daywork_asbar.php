...
class daywork_asbar extends Model
{
    ...
    protected $fillable = ['id_kontraktor','id_item_daywork_asbar','currency_adjustment','index','premium_rate','general_escalation','base_rate_exc_fuel','actual_rate_exc_fuel','contract_reference','created_at','updated_at',];
}
