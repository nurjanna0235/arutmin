...
class haul_road_maintenance_pltu extends Model
{
    ...
    protected $fillable = ['id_kontraktor','base_rate','currency_adjustment','premium_rate','general_escalation','actual_rate_hauling_pltu','contract_reference','created_at','updated_at','name_contract'];
}
